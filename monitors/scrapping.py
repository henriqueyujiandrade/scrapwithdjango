...
class Scrapper:
    ...
    def get_terabyte_data():
        ...
        monitors_data = site.find_all(
            "div", attrs={"class": "commerce_columns_item_inner"}
        )
        ...
        for monitor_data in monitors_data:
            ...
            if price and hz >= 144:
                ...
                new_data = {
                    ...
                    "current_price": current_price.translate(
    ...
    def get_kabum_data(input):
        ...
        driver = uc.Chrome(options=options)
        driver.get(
            f"https://www.kabum.com.br/computadores/monitores/monitor-gamer?page_number={input}&page_size=100&facet_filters=&sort=price"
        )
        page_content = driver.page_source
        site = BeautifulSoup(page_content, "html.parser")
        ...
        for monitor_data in monitors_data:
            ...
            if price and not "---" in price.text and hz >= 144:
                ...
                new_data = {
                    "description": description.text,
                    "current_price": final_price.translate(
                        {ord(i): None for i in "R$. "}
                    ),
                    "category": "monitor",
                    "store": "kabum",
